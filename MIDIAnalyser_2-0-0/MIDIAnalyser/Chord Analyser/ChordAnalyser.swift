...
class ChordAnalyser {
    ...
    func analysePermutation(intervals: [Int], root: String) -> Chord {
    ...
    func countKeysPressed(_ keyStates: [Bool]) -> Int {
    ...
    // list unique notes
    func notesInChord(keyStates: [Bool], nKeysPressed: Int) -> [Int] {
    ...
    func noteNamesInChord(_ notes: [Int]) -> [String] {
    ...
    func determineIntervals(_ notes: [Int]) -> [Int] {
    ...
    func generateIntervalSets(_ intervals: [Int]) -> [[Int]] {
